            ...
            <div class="detalhes">
                <div class="recentesobs">
                    <div class="cardheader">
                        ...
                        <a class="voltar" href="principal.php?p=buscar_ferramenta.php">Voltar</a>
...
if (isset($_POST["resp"])){
    ...
    $descricao = 'Entrega efetuada';
        ...
        {   
                ...
                if($u->entregar_tool($respo, $responsavel, $user, $data_alt, $idtool, $cidade, $tipo_ocorrencia, $descricao)){
