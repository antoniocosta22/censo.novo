...
.new {
    ...
    border-radius: 10px 0px 15px 0px;
           ...
           <div class="cardbox">
                ...
                <a class="link" href="principal.php?p=adm/lancar_metas.php">
                <div class="card">
                    <div>
                        <div class="numbers">Metas</div>
                ...
                <div class="card">
                    <div>
                        <div class="numbers">Centrais</div>
                        <div class="cardname">CAS</div>
                    </div>
                    <div class="iconbox">
                ...
                <div class="card">
                    <div>
                        <div class="numbers">Instituições</div>
                        <div class="cardname">CAS</div>
                    </div>
                    <div class="iconbox">
