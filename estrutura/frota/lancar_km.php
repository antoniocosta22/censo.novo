...
<div class="cardbox">
            ...
            <div class="detalhes">
                <div class="recentesobs">
                    ...
                    <input class="form" name="km" type="text" placeholder="KM atual" REQUIRED>
...
if (isset($_POST['km'])){   
    ...
    if(!empty($km)){
        ...
        {   
                if($u->lancar_km($user, $ocorrencia, $carro, $km, $obs, $data_cad)){

                    ?>

                    <script src="./js/swalert.js"></script>
                    <script>
                        swal("Feito!", "Kilometragem registrada!","success").then( () => {
                            window.close();
                        })
                    </script>
