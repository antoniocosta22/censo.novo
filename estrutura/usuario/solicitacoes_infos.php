            ...
            <div class="detalhes">
                ...
                <div class="recentesobs">
                    ...
                    <h5>SOLICITACÃO Nº - <?= $carros['solicitacao'];?></h5>
                        ...
                        <div class="dropdown">
                        <a href="principal.php?p=<?=$pagina_ant?>" class="dropbtn" style="padding: 5px 15px; border-radius: 5px; background: white; text-decoration: none; ">Voltar</a>
                        </div>
                    </div>
