            ...
            <div class="detalhes_frota">
                <div class="recentesobs_frota">
                    ...
                    <table id="teste">
                        ...
                        <tbody>
                        <?php 
                        $frota = $pdo->prepare(" SELECT solicitacao, status, usuario, depart, datacad, avaliar FROM solicitacoes WHERE status = 'EN' AND finalizador = $user ORDER BY avaliar asc ");
                        $frota->execute();
                        if($frota->rowCount() > 0){
                        ...
                        ?>
                            <tr style="border-bottom: 1px solid rgb(0, 140, 255);">
                                ...
                                <td><a href="principal.php?p=usuario/solicitacoes_infos.php&sl=<?= $carros['solicitacao'];?>&pg_atual=usuario/meus_servicos.php" style=" text-decoration: none; "><span class="status a" style="background-color: slategray;  color: white;">Infos</span></a></td>
