...
.new {
    ...
    border-radius: 10px 0px 15px 0px;
           ...
           <div class="cardbox">
                ...
                <a class="link" href="principal.php?p=relatorios/vendas_gerais.php">
                <div class="card">
                    <div>
                        <div class="numbers">Vendas</div>
                        <div class="cardname">mensais</div>
                    </div>
                    <div class="iconbox">
                ...
                <div class="card">
                    <div>
                        <div class="numbers">Solicitações</div>
                        <div class="cardname">colaboradoes</div>
                    </div>
                    <div class="iconbox">
                ...
                <a class="link" href="principal.php?p=relatorios/vendas_colab.php">
                <div class="card">
                    <div>
                        <div class="numbers">Vendas</div>
                        <div class="cardname">colaboradoes</div>
