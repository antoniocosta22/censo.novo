            ...
            <div class="detalhes">
                ...
                <div class="recentesobs">
                    ...
                    <table id="vendas">
                        ...
                        $mes = date("m");
                        $ano = date("Y");
                        $frota = $pdo->prepare("SELECT * FROM vendas WHERE  MONTH(data_cad)=$mesatual AND YEAR(data_cad) = $anoatual");
                        $frota->execute();
                ...
                <div class="recentesobs">
                    ...
                    <table id="vendas">
                        ...
                        $mes = date("m");
                        $ano = date("Y");
                        $frota = $pdo->prepare("SELECT * FROM vendas WHERE MONTH(data_cad)=$mes AND YEAR(data_cad) = $ano");
                        $frota->execute();
