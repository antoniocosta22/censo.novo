            ...
            <div class="detalhes">
                <div class="recentesobs">
                    ...
                    <h5>CLIENTE - <?= $carros['nome'];?></h5>
                        ...
                        <!-- <div class="dropdown">
                        <a href="principal.php?p=vendas/fila_alt.php&&v=<?=$pagina_anterior?>" class="dropbtn" style="padding: 5px 15px; border-radius: 5px; background: white;">Voltar</a>
                        </div> -->
                    </div>
                    ...
                    <label class="form"><label class="status mig_t">ESTADO CIVIL:</label> 
                    <?php
                        if($carros['estcivil'] == 's'){
                            $est_civi = 'Solteiro (a)';
                        }elseif ($carros['estcivil'] == 'c'){
                            $est_civi = 'Casado (a)';
                        }elseif ($carros['estcivil'] == 'v'){
                            $est_civi = 'Viuvo (a)';
                        }elseif ($carros['estcivil'] == 'd'){
                            $est_civi = 'Divorciado (a)';
                        }elseif ($carros['estcivil'] == 'v'){
                            $est_civi = 'Viuvo (a)';
                        }
                    ?>
                    ...
                    <label class="form"><label class="status mig_t">INFORMAÇÕES:</label>
                        <?=$carros['detalhe_consol'];?>
                    </label>
                </div>
                <!-- fim do card -->
            </div>
