...
<head>
    ...
    <title>CENSO - Painel de Cancelamento</title>
            ...
            <div class="detalhes">
                <div class="recentesobs">
                    <div class="cardheader">
                        ...
                        <label id="att" for="attu" class="botao" value="button">Cancelar</label>
                    </div>
                    <!--  inicio  -->
                    <form method="POST" >
                    ...
                    <textarea class="textarea" name="obs" rows="5" type="textarea" placeholder="Motivo do cancelamento" REQUIRED></textarea>
...
if (isset($_POST["obs"])){  
    ...
    if(!empty($detalhe_consol) AND !empty($data_consol)){
        ...
        {   
                ...
                if($u->cancelar_venda($id_venda, $user, $consolidada, $data_consol, $detalhe_consol, $data_cad_consol)){
