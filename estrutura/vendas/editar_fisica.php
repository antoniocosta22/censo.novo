...
<div class="cardbox">
            ...
            <div class="detalhes">
                <div class="recentesobs">
                    ...
                    <form method="POST" >
                        <!-- nome do cliente -->
                    <input class="form" name="nome" type="text" placeholder="Nome" value="<?=$data_cliente['nome']?>">
                    <!-- card -->
                    <div class="cardheader">
                        <!-- select sexo -->
                        <select name="sexo" class="cidade" >
                                <option value="<?=$data_cliente['sexo']?>">
                                <?php
                                if ($data_cliente['sexo'] == 'f'){
                                    $sexo = 'Feminino';
                                }else {
                                    $sexo = 'Masculino';
                                }?>
                        ...
                        <!-- apelido -->
                        <input class="form_a" name="apelido" type="text" placeholder="Conhecido por" value="<?=$data_cliente['apelido']?>">
                    </div>
                    <!-- card -->
                    <div class="cardheader">
                        <!-- nome da mae -->
                        <input class="form" name="mae" type="text" placeholder="Nome da mãe" value="<?=$data_cliente['mae']?>">
                        <!-- nome do pai -->
                        <input class="form_a" name="pai" type="text" placeholder="Nome do pai" value="<?=$data_cliente['pai']?>">
                    </div>
                    <!-- card -->
                    <div class="cardheader">
                    <!-- endereço -->
                    ...
                    <div class="cardheader">
                        <!-- email -->
                        <input class="form" name="email" type="text" placeholder="E-mail" value="<?=$data_cliente['email']?>">
                        <!-- profissão -->
                        <input class="form_a" name="profi" type="text" placeholder="Profissão" value="<?=$data_cliente['profi']?>">
                    </div>
                    <!-- Seleção da cidade -->
                    <div class="cardheader">
                        <!-- cidade -->
                        ...
                        <!-- equipamento -->
                        <select name="estcivil" class="equipamento">
                                <option value="<?=$data_cliente['estcivil']?>">
                                <?php
                                if ($data_cliente['estcivil'] == 's'){
                                    $estado_c = 'Solteiro(a)';
                                }elseif ($data_cliente['estcivil'] == 'c') {
                                    $estado_c = 'Casado(a)';
                                }elseif ($data_cliente['estcivil'] == 'd') {
                                    $estado_c = 'Divorciado(a)';
                                }elseif ($data_cliente['estcivil'] == 'u') {
                                    $estado_c = 'União Estável';
                                }elseif ($data_cliente['estcivil'] == 'v') {
                                    $estado_c = 'Viuvo(a)';
                                }
                                ?>
                                <?=$estado_c?>
                    ...
                    <div class="cardheader">
                        <!-- cep -->
                        <input id="cep" class="form" name="cep" type="text" placeholder="CEP" value="<?=$data_cliente['cep']?>">
                        <!-- bairro -->
                        <input class="form_a" name="bairro" type="text" placeholder="Bairro" value="<?=$data_cliente['bairro']?>">
                    </div>
                    <!-- card -->
                    <div class="cardheader">
                        <!-- naturalidade -->
                        <input class="form" name="natur" type="text" placeholder="Naturalidade" value="<?=$data_cliente['natur']?>">
                        <!-- data de nascimento -->
                        <?php
                        ...
                        ?>
                        <input class="form_a" id ="data" name="datanasc" type="text" placeholder="Data de nascimento"  value="<?=$datanasc?>">
                    </div>
                    <!-- card -->
                    <div class="cardheader">
                        <!-- RG -->
                        <input id="rg" class="form" name="rg" type="text" placeholder="RG" value="<?=$data_cliente['rg']?>">
                        <!-- CPF -->
                        <input id="cpf" class="form_a" name="cpf" type="text" placeholder="CPF" value="<?=$data_cliente['cpf']?>">
                    </div>
                    <!-- card -->
                    <div class="cardheader">
                        <!-- Telefone 01 -->
...
if (isset($_POST["nome"])){   
    ...
    $cidade = $_POST["cidade"];
    $cep = $_POST["cep"];
    //data de nascimento de nascimento
    ...
    if($plano != 'x'){
        ...
        {   
                ...
                if($u->atualizar_venda($user, $nome, $apelido, $mae, $sexo, $pai, $ender, $ref, $bairro, $cidade, $cep, $datanasc, $rg, $cpf, $natur, $estcivil, $profi, $fone1, $fone2, $email, $plano, $equip, $neg, $ccred, $parc, $vend, $obs, $datacad, $id_cliente, $indicacao, $indicador )){
                    ...
                    <script>
                        setTimeout(() => {
                        location.href = 'principal.php?p=vendas/fila_vendas.php&x!=<?=$cid_sigla?>&v=<?=$pagina_anterior?>'
                        }, 300)
                    </script>
                    <?php
