            ...
            <div class="detalhes">
                <div class="recentesobs">
                    ...
                    <div class="cardheader">
                        ...
                        <!-- apelido -->
                        <input class="form_a" name="apelido" type="text" placeholder="Conhecido por">
                    </div>
                    <!-- card -->
                    <div class="cardheader">
                        <!-- nome da mae -->
                        <input class="form" name="mae" type="text" placeholder="Nome da mãe" REQUIRED>
                        <!-- nome do pai -->
                        <input class="form_a" name="pai" type="text" placeholder="Nome do pai" REQUIRED>
                    </div>
                    <!-- card -->
                    <div class="cardheader">
                    <!-- endereço -->
                    ...
                    <div class="cardheader">
                        <!-- email -->
                        <input class="form" name="email" type="text" placeholder="E-mail" REQUIRED>
                        <!-- profissão -->
                        <input class="form_a" name="profi" type="text" placeholder="Profissão" REQUIRED>
                    </div>
                    <!-- Seleção da cidade -->
                    <div class="cardheader">
                        <!-- cidade -->
                        ...
                        <select name="estcivil" class="equipamento">
                                <option value="x">Estado civil</option>
                    ...
                    <div class="cardheader">
                        <!-- cep -->
                        <input id="cep" class="form" name="cep" type="text" placeholder="CEP" REQUIRED>
                        <!-- bairro -->
                    ...
                    <div class="cardheader">
                        <!-- naturalidade -->
                        <input class="form" name="natur" type="text" placeholder="Naturalidade" REQUIRED>
                        <!-- data de nascimento -->
                    ...
                    <div class="cardheader">
                        <!-- RG -->
                        <input id="rg" class="form" name="rg" type="text" placeholder="RG" REQUIRED>
                        <!-- CPF -->
                        <input id="cpf" class="form_a" name="cpf" type="text" placeholder="CPF" REQUIRED>
                    </div>
                    <!-- card -->
                    <div class="cardheader">
                        <!-- Telefone 01 -->
...
if (isset($_POST["nome"])){   
    ...
    if($estcivil != 'x' AND $neg != 'x' AND $plano != 'x' AND $cidade != 'x' AND $equip != 'x' AND $indicacao != 'x' AND $vend != 'x'){
        ...
        {   
                ...
                if($u->cadastrar($indicacao, $indicador, $user, $tipo, $nome, $apelido, $mae, $sexo, $pai, $ender, $ref, $bairro, $cidade, $uf, $cep, $datanasc, $rg, $cpf, $natur, $estcivil, $profi, $fone1, $fone2, $email, $plano, $equip, $neg, $ccred, $parc, $vend, $obs, $datacad, $consolidada )){
